...
- (void)viewDidLoad {
    ...
    [rightButton addTarget:self action:@selector(undoAction:)forControlEvents:UIControlEventTouchUpInside];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:236/255.0 green:74/255.0 blue:72/255.0 alpha:1]}];
