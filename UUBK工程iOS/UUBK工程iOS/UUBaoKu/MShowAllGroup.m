...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedStringFromTable(@"照片", @"Location", nil);
    ...
    UIBarButtonItem *rightBar = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"取消", @"Location", nil) style:UIBarButtonItemStylePlain target:self action:@selector(actionRightBar)];
