...
-(void)showImgPickerActionSheetInView:(UIViewController *)controller{
    ...
    UIAlertAction *actionCancel = [UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"取消", @"Location", nil) style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    UIAlertAction *actionCamera = [UIAlertAction actionWithTitle:[NSString stringWithFormat:NSLocalizedStringFromTable(@"拍照", @"Location", nil)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        if (!imaPic) {
    ...
    UIAlertAction *actionAlbum = [UIAlertAction actionWithTitle:[NSString stringWithFormat:NSLocalizedStringFromTable(@"相册", @"Location", nil)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
