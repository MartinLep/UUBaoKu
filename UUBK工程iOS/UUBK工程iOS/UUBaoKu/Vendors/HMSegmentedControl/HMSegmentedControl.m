...
- (void)commonInit {
    ...
    if (self.boundaryLine == nil) {
        self.boundaryLine = [[UIView alloc] init];
        _boundaryLine.backgroundColor = [UIColor grayColor];
    }
}
...
- (void)updateSegmentsRects {
    ...
    if ([self sectionCount] > 0 && self.segmentWidth == 0.f) {
