...
- (void)initialize {
    ...
    _gradientTopColor = [UIColor colorWithRed:196/255.0 green:60/255.0 blue:58/255.0 alpha:1.0f];
    
    _gradientBottomColor = [UIColor colorWithRed:196/255.0 green:60/255.0 blue:58/255.0 alpha:1.0f];
    ...
    self.layer.borderColor = [[UIColor colorWithRed:236/255.0 green:74/255.0 blue:72/255.0 alpha:1] CGColor];
