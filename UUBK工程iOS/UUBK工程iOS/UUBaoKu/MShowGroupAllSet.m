...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBar = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"确定", @"Location", nil) style:UIBarButtonItemStylePlain target:self action:@selector(actionRightBar)];
...
//    ALAsset *asset = selecedImageViewIndex;
//    
//    
