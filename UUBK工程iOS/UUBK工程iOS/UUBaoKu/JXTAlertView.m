...
- (void)showAlertViewWithTitile:(NSString *)title andTitle:(NSString *)detailTitle andConfirmAction:(ClickBlock)confirmBlock andReloadAction:(ReloadBlock)refreshBlcok andCancelAction:(CancelBlock)cancel
{
    ...
    _operateView.bounds = CGRectMake(0, 0, ScreenWidth - 32, 168);
    ...
    [_operateView addSubview:titleLab];
    [titleLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(_operateView.mas_centerX);
        make.top.mas_equalTo(_operateView.mas_top).mas_offset(15);
        make.width.mas_equalTo(_operateView.width - 40);
    ...
    [_operateView addSubview:detailTitleLab];
    ...
    detailTitleLab.text = detailTitle;
    detailTitleLab.textAlignment = NSTextAlignmentCenter;
    detailTitleLab.font = [UIFont systemFontOfSize:13];
    detailTitleLab.textColor = UUGREY;
    /**
     *  按钮
     */
    ...
    [confirmBtn setTitleColor:UURED forState:UIControlStateNormal];
    ...
    inputBkView.bounds = CGRectMake(0, 30, CGRectGetWidth(_operateView.frame) - 20, 28);
    inputBkView.center = CGPointMake(CGRectGetMidX(_operateView.bounds), 32 + 24+30);
     ...
     *  输入框
     */
    _inputTextField = [[UITextField alloc] initWithFrame:CGRectMake(10, 30, CGRectGetWidth(inputBkView.bounds)-20, CGRectGetHeight(inputBkView.bounds))];
    _inputTextField.delegate = self;
    _inputTextField.keyboardType = UIKeyboardTypeDefault;
    _inputTextField.returnKeyType = UIReturnKeyDone;
    _inputTextField.font = [UIFont systemFontOfSize:16];
    _inputTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入内容" attributes:@{NSForegroundColorAttributeName:UIColorFromHEX(0xcccccc, 1), NSFontAttributeName:[UIFont systemFontOfSize:16]}];
...
- (void)showAlertViewWithTitile:(NSString *)title andTitle:(NSString *)detailTitle andConfirmAction:(ClickBlock)confirmBlock andReloadAction:(ReloadBlock)refreshBlcok
{
    ...
    _operateView = [[UIView alloc] init];
    _operateView.center = CGPointMake(ScreenWidth/2., ScreenHeight/2.);
    _operateView.bounds = CGRectMake(0, 0, ScreenWidth - 32, 138);
    _operateView.backgroundColor = [UIColor whiteColor];
    _operateView.layer.cornerRadius = 6;
    _operateView.clipsToBounds = YES;
    [_alertBackgroundView addSubview:_operateView];
...
//    [_reloadImageBtn setBackgroundImage:[VerifyNumberView iniVerifyNumberImage] forState:UIControlStateNormal];
    ...
    _inputTextField.returnKeyType = UIReturnKeyDone;
    _inputTextField.font = [UIFont systemFontOfSize:16];
    _inputTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:detailTitle attributes:@{NSForegroundColorAttributeName:UIColorFromHEX(0xcccccc, 1), NSFontAttributeName:[UIFont systemFontOfSize:16]}];
    _inputTextField.textColor = UIColorFromHEX(0x333333, 1);
    _inputTextField.clearButtonMode = UITextFieldViewModeWhileEditing;
    [inputBkView addSubview:_inputTextField];
}
