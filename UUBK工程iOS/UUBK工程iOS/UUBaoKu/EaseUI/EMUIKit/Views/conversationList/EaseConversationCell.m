...
- (void)getUserInfoWithUserId:(NSString *)userId{
    ...
    [NetworkTools postReqeustWithParams:dict UrlString:urlString successBlock:^(id responseObject) {
        self.titleLabel.text = responseObject[@"data"][@"NickName"];
        [self.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:responseObject[@"data"][@"FaceImg"]] placeholderImage:_model.avatarImage];
...
//    [self getUserInfoWithUserId:model.conversation.conversationId];
