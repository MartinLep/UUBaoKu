...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(conversationListViewController:didSelectConversationModel:)]) {
        ...
        EaseConversationModel *model = [self.dataArray objectAtIndex:indexPath.row];
        NSDictionary *toUser = @{@"NickName":model.title,@"FaceImg":model.avatarURLPath};
        EaseMessageViewController *viewController = [[EaseMessageViewController alloc] initWithConversationChatter:model.conversation.conversationId conversationType:model.conversation.type andToUserInfo:toUser];
